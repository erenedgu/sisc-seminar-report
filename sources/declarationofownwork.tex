...
\begin{itemize}
  \item \textbf{Gemini (Google)} — Used for grammar checking, text polishing, literature search assistance, and refining LaTeX formatting across all chapters.
  \item \textbf{GitHub Copilot (GitHub / OpenAI)} — Used for code generation, code completion, and script optimization.
\end{itemize}
